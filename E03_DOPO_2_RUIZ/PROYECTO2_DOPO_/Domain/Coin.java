 ...
 * Tipos: YELLOW, SKIN_RED, SKIN_BLUE, SKIN_GREEN.
 * Las monedas de color cambian temporalmente el color del jugador.
 *
...
public class Coin extends Rectangle {
    ...
    public void collect(Player player) {
        ...
        switch (type) {
            case SKIN_RED:
                player.applyTemporarySkin(Player.Skin.ROJO);
                break;
            case SKIN_BLUE:
                player.applyTemporarySkin(Player.Skin.AZUL);
                break;
            case SKIN_GREEN:
                player.applyTemporarySkin(Player.Skin.VERDE);
                break;
            default:
                break;
        }
